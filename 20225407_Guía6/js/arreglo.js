...
function agregarElemento() {
    let numero = parseInt(document.querySelector("#inputNumero").value);
    ...
    if (isNaN(numero)) {
        ...
        containerArreglo.insertAdjacentElement("beforeend", caja); // Elemento dentro de idContainerArreglo y después de su último hijo
    }
}
